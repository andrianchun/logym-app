...
> **📁 Lokasi Penyimpanan Aset Tunggal**:
> Simpan SEMUA file gambar (\`.webp\` / \`.png\`) dan video (\`.mp4\`) langsung ke dalam **satu folder tunggal**:
> \`public/exercise-assets/\`
> 
> *Contoh:*
> - Gambar: \`public/exercise-assets/edb-Dumbbell_Bench_Press.webp\`
> - Video: \`public/exercise-assets/edb-Dumbbell_Bench_Press.mp4\`
...
console.log('Successfully updated to single folder structure!');
