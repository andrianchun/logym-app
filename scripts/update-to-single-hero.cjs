...
let md = `# Panduan Lengkap Prompt AI: Single Hero Frame (1:1) & Video How-To

> **🌟 Standar Terbaik: Single High-Definition Hero Shot (1 Frame Penuh)**:
> 1. **🖼️ Gambar Thumbnail (1:1 Single Hero Frame)**:
>    - **1 Subjek Penuh**, 1 Wajah Coach yang 100% konsisten, 1 Alat Gym yang presisi.
>    - Dilengkapi efek **Glowing Cyan Wireframe Anatomical Muscle Highlight** pada otot target.
> 2. **🎥 Video AI (1 Frame Full Sinematik)**:
>    - Menggunakan gambar Single Hero sebagai First Frame.
>    - Digerakkan dengan prompt berbasis **How-To langkah per langkah bahasa Inggris** (seamless loop).
...
## 🎨 2. Cara Eksekusi Single Hero Image + Video AI
...
3. **Generate Video AI (Kling / Runway / Luma)**:
   * **Upload Hasil Gambar Single Hero** sebagai First Frame (*Image-to-Video*).
   * **Copas Prompt 2 (Video How-To)** di bawah.

---

## 📋 3. Daftar Lengkap Prompt Single Hero Image & Video How-To (31 Latihan)
...
Moody atmospheric gym, dramatic volumetric rim lighting highlighting muscle definition and striations, sweat glistens under studio lighting, 8k resolution, 60fps, ultra-realistic motion blur, masterclass fitness production.`;
  ...
  md += `    <p><b>🎯 Otot Target (Glowing Cyan Wireframe):</b> ${item.muscles}</p>\n`;
...
console.log('Successfully updated to Single Hero Frame 1:1 and Video prompts!');
