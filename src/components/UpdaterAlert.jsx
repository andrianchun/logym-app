...
export default function UpdaterAlert({
  ...
  return (
    <div className="fixed bottom-24 inset-x-4 z-[100] flex justify-center pointer-events-none animate-in slide-in-from-bottom-8 fade-in duration-500">
      <div className={`pointer-events-auto ${t.bgCard} ${t.textMain} rounded-2xl p-4 shadow-2xl w-full max-w-sm border ${t.border} flex flex-col gap-3 relative overflow-hidden backdrop-blur-xl`}>
