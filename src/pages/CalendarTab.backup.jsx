      ...
      >
         ...
         <div
            ref={scrollContainerRef}
             className="relative z-10 flex-1 min-h-0 overflow-y-auto hide-scrollbar px-4 sm:px-6 pb-32"
         >
            {/* Heading Jadwal Latihan dihilangkan sesuai permintaan user */}
            {/* flex-1 supaya PanoramicSlider (fillHeight) mengisi seluruh sisa tinggi sheet —
                jadi tidak ada lagi area kosong di bawah yang tidak merespons swipe/drag. */}
             ...
             <PanoramicSlider
               ...
               renderPanel={(panelType) => {
                   ...
                   return (
                     ...
                     >
                       <div ref={isCurr ? sheetContentRef : undefined} className="px-3 sm:px-6 pb-6 flex flex-col gap-3">
                                            ...
                                            {isExpanded && (
                                              <div className="mt-4 pt-4 border-t border-black/10 dark:border-white/10 animate-in slide-in-from-top-2 fade-in duration-300 ease-out">
                                                ...
                                                <div className="flex gap-2">
                                                   <button onClick={(e) => { e.stopPropagation(); setExpandedWorkoutId(null); setCalendarMode('monthly'); }} className={`flex-1 py-3 rounded-xl border border-dashed border-black/20 dark:border-white/20 body-lg font-bold ${c.text}`}>Tutup</button>
